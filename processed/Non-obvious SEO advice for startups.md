...
source: "https://posthog.com/newsletter/seo-for-startups"
author:
published:
created: 2026-06-10
description: "There’s no shortage of SEO advice for startups out there. Things like: You need an up-to-date sitemap.  Sure, having one is better than not.    Think…"
tags:
  - "clippings"
---
![Non-obvious SEO advice for startups](https://res.cloudinary.com/dmukukwp6/image/upload/f_webp,h_545,w_968,c_fill,g_auto,q_auto/seo_meme_thumb_2894e1ee9b?_a=AXAH4nI0)
...
*Words by [Andy Vandervell](https://www.linkedin.com/in/andyvandervell/), who ranks top of Google for his own name.*
...
> PostHog is an all-in-one developer platform for building successful products. We provide [product analytics](https://posthog.com/product-analytics), [web analytics](https://posthog.com/web-analytics), [session replay](https://posthog.com/session-replay), [error tracking](https://posthog.com/error-tracking), [feature flags](https://posthog.com/feature-flags), [experiments](https://posthog.com/experiments), [surveys](https://posthog.com/surveys), [AI Observability](https://posthog.com/ai-observability), [logs](https://posthog.com/logs), [workflows](https://posthog.com/workflows), [endpoints](https://posthog.com/endpoints), [data warehouse](https://posthog.com/data-warehouse), [CDP](https://posthog.com/cdp), and an [AI product assistant](https://posthog.com/ai) to help debug your code, ship features faster, and keep all your usage and customer data in one stack.

### Community questions

- [**Felix**](https://posthog.com/community/profiles/40070) 5
	6 months ago
	### Domain
	Is there a big difference between website.com/blog and blog.website.com? subfolder vs subdomain. I use webflow and unable to have a subfolder
	- [**Andy**](https://posthog.com/community/profiles/30208) Hogfather · 810
		6 months ago
		Honestly, not my area of expertise tbh, sorry!
