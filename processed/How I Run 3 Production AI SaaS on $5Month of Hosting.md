...
source: "https://dev.to/rikuq/how-i-run-3-production-ai-saas-on-5month-of-hosting-40fd"
author:
  - "[[Ravi Patel]]"
published: 2026-05-25
created: 2026-05-29
description: "My complete 2026 stack — Cloudflare, Supabase, Paddle, Razorpay, Claude — and why hosting costs nothing while AI does. Honest picks from shipping. Tagged with productionstack, cloudflare, supabase, solofounder."
tags:
  - "clippings"
---
*Originally published on [rikuq.com](https://rikuq.com/blog/stack/production-stack-2026/). Republished here for Dev.to's readers.*
...
**Dev work:** Claude Code on the $200/month Anthropic Max (20×) plan. Covered in depth in the [Claude Code review](https://rikuq.com/blog/tools/claude-code-review). The short version: cheapest engineer I'll ever hire.
...
For solo founders who don't run their own gateway: use [Claude](https://www.anthropic.com/) direct for highest quality, [OpenAI](https://openai.com/) for proven reliability, or wire up multi-provider routing via something like Prism (or build your own — see [Prism's architecture](https://rikuq.com/case-studies/prism) once it's published).
...
[Notion](https://www.notion.so/) is where I plan what Claude Code builds. Specs, decision logs, scratch notes, project trackers, my [what-i-did.md equivalents](https://rikuq.com/blog/tools/claude-code-review) for high-level planning. The killer feature for solo work isn't any specific Notion capability — it's that *one tool* holds your spec, your roadmap, your meeting notes, your reference docs, and your decision archive without making you switch between five apps.
...
- **[Claude Code Review 2026 — From Zero Code to 3 Live SaaS](https://rikuq.com/blog/tools/claude-code-review)** — the AI dev tool that costs $200/month and saves more than it costs
- **[Best AI Coding Tools 2026](https://rikuq.com/blog/tools/best-ai-coding-tools-2026)** — full landscape if you're evaluating dev tools
- **[Anthropic prompt caching: real numbers from production](https://rikuq.com/blog/infra/anthropic-prompt-caching-real-numbers)** *(coming soon)* — how to cut Claude bills 35-45%
- **[How I built Citare in 12 days with Claude Code](https://rikuq.com/case-studies/citare)** *(coming soon)* — the case study showing this stack in action at velocity

---

*Last updated 2026-05-23. The stack moves fast — I refresh this whenever a material price/tier change happens. If you spot something stale, [tell me on Twitter/X](https://twitter.com/rikuq).*[MongoDB](https://dev.to/mongodb)Promoted
